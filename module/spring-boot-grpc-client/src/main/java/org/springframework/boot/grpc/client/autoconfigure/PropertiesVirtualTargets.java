 ...
 * @author Phillip Webb
 */
public class PropertiesVirtualTargets implements VirtualTargets {

	private final PropertyResolver propertyResolver;

	private final GrpcClientProperties properties;

	PropertiesVirtualTargets(PropertyResolver propertyResolver, GrpcClientProperties properties) {
	...
	public String getTarget(String target) {
		...
		if (channel != null) {
			return clean(channel.getTarget());
		}
