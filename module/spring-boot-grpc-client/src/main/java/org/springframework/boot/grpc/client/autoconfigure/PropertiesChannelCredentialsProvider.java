 ...
 * @author Phillip Webb
 */
class PropertiesChannelCredentialsProvider implements ChannelCredentialsProvider {

	private final GrpcClientProperties properties;

	private final SslBundles bundles;

	PropertiesChannelCredentialsProvider(GrpcClientProperties properties, SslBundles bundles) {
