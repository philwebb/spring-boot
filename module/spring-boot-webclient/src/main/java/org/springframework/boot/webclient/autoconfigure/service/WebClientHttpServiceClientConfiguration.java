...
final class WebClientHttpServiceClientConfiguration implements BeanClassLoaderAware {
	...
	@Bean
	WebClientPropertiesHttpServiceGroupConfigurer webClientPropertiesHttpServiceGroupConfigurer(Environment environment,
		...
		return new WebClientPropertiesHttpServiceGroupConfigurer(this.beanClassLoader, environment, sslBundles,
				serviceProperties, clientConnectorBuilder, clientConnectorSettings, apiVersionInserter,
				apiVersionFormatter);
	}
	...
	@Bean
	WebClientHttpServiceClientGroupVerifier webClientHttpServiceClientGroupVerifier() {
