...
class GrpcServerBuilderCustomizersTests {
	...
	void applyWhenEmptyCustomizersDoesNothing() {
		...
		new GrpcServerBuilderCustomizers(null, null, null, Collections.emptyList()).apply(serverBuilder);
		then(serverBuilder).shouldHaveNoInteractions();
	}

	@Test
	void applyWhenSimpleCustomizer() {
		GrpcServerBuilderCustomizers customizers = new GrpcServerBuilderCustomizers(null, null, null,
	...
	void applyWhenGenericCustomizersRespectsGeneric() {
		...
		GrpcServerBuilderCustomizers customizers = new GrpcServerBuilderCustomizers(null, null, null, list);
	...
	void applyWhenHasInjectedBeans() {
		...
		GrpcServerBuilderCustomizers customizers = new GrpcServerBuilderCustomizers(compressorRegistry,
