...
class GrpcNettyServerConfiguration {
	...
	NettyGrpcServerFactory nettyGrpcServerFactory(GrpcServerProperties properties,
		...
		ServerCredentials credentials = ServerCredentials.get(properties, bundles,
				InsecureTrustManagerFactory.INSTANCE);
		NettyGrpcServerFactory factory = new NettyGrpcServerFactory(properties.getAddress(),
				serverBuilderCustomizers.forFactory(), credentials.keyManager(), credentials.trustManager(),
