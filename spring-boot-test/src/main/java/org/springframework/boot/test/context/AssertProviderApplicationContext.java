...
interface AssertProviderApplicationContext<C extends ApplicationContext>
	 ...
	 */
	static <T extends AssertProviderApplicationContext<C>, C extends ConfigurableApplicationContext> T get(
			Class<T> type, Class<C> contextType, Supplier<? extends C> contextSupplier) {
		return null;
	}
