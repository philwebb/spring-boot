 ...
 */
public final class GroupMetadata extends ItemMetadata {

	public GroupMetadata(String name, String sourceType, String sourceMethod,
			String description) {
		super(name, sourceType, sourceMethod, description);
	}

	public GroupMetadata(String prefix, String name, String sourceType,
