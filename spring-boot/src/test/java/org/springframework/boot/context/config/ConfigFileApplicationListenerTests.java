...
import org.springframework.boot.context.config.ConfigFileApplicationListener.ConfigurationPropertySourcesDunno;
...
public class ConfigFileApplicationListenerTests {
	...
	public void yamlSetsProfiles() throws Exception {
		...
		assertThat(property).isEqualTo("fromdevprofile");
		ConfigurationPropertySourcesDunno propertySource = (ConfigurationPropertySourcesDunno) this.environment
				.getPropertySources()
	...
	private Condition<ConfigurableEnvironment> matchingPropertySource(
		...
		return new Condition<ConfigurableEnvironment>(
			...
			public boolean matches(ConfigurableEnvironment value) {
				...
				ConfigurationPropertySourcesDunno.finishAndRelocate(sources);
