...
public class RandomAccessJarFile extends JarFile {
	...
	/**
	 * Return a URL that can be used to access this JAR file. The returned URL
	 * will connect using a {@link RandomAccessJarURLConnection}. NOTE: the specified URL
	...
	/**
	 * {@link RandomAccessJarURLConnection} used to support {@link RandomAccessJarFile#getUrl()}.
	 */
	private static class RandomAccessJarURLConnection extends JarURLConnection {
		...
		public String getContentType() {
			if(this.contentType == null) {
				// Guess the content type, don't bother with steams as mark is not supported
				this.contentType = (this.jarEntryName == null ? "x-java/jar" : null);
				this.contentType = (this.contentType == null ? guessContentTypeFromName(this.jarEntryName) : contentType);
				this.contentType = (this.contentType == null ? "content/unknown" : contentType);
			}
