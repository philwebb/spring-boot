 ...
 * @see #run(String...)
 */
public class CopyOfSpringApplication {
	...
	private static CopyOfSpringApplication instance;
	...
	private BeanDefinitionRegistryPostProcessor getBeanFactoryPostProcessorHook(
		...
		return new BeanDefinitionRegistryPostProcessor() {
			...
			public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry)
					throws BeansException {
				CopyOfSpringApplication.this.postProcessBeanDefinitionRegistry(configuration, registry);
			}
		};
	}
	...
	private AttributeAccessor registerSelf(BeanDefinitionRegistry registry) {
		BeanDefinition beanDefinition = new RootBeanDefinition(CopyOfSpringApplication.this.getClass());
	...
	protected void scan(ApplicationConfigurationDetails configuration, BeanDefinitionRegistry registry, String[] basePackages) {
		...
		scanner.addExcludeFilter(new AbstractTypeHierarchyTraversingFilter(false, false){
			...
			protected boolean matchClassName(String className) {
				return CopyOfSpringApplication.this.getClass().getName().equals(className);
			}
		});
	...
	public static CopyOfSpringApplication getInstance() {
		return instance;
	}


	/**
	 * Callback interfaces that allows configuration of the {@link CopyOfSpringApplication}.
