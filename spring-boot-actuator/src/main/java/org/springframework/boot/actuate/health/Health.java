...
public final class Health {
	...
	/**
	 * Create a new {@link Health} instance with an {@link Status#UNKNOWN} status an the
	 * specified details.
	 * @param key the details key
	 * @param data the details data
	 * @return a new {@link Health} instance
	 */
	public static Health unknown(String key, Object data) {
		return unknown().withDetail(key, data);
	}
	...
	/**
	 * Create a new {@link Health} instance with an {@link Status#UP} status an the
	 * specified details.
	 * @param key the details key
	 * @param data the details data
	 * @return a new {@link Health} instance
	 */
	public static Health up(String key, Object data) {
		return up().withDetail(key, data);
	}
