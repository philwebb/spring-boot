	...
	protected static class ManagementWebSecurityConfigurerAdapter extends
		...
		private final class EndpointPathRequestMatcher implements RequestMatcher {
			...
			public boolean matches(HttpServletRequest request) {
				if (ManagementWebSecurityConfigurerAdapter.this.endpointHandlerMapping == null
				...
				if (this.delegate == null) {
					...
					String[] paths = !this.sensitive ? getEndpointPaths(
							ManagementWebSecurityConfigurerAdapter.this.endpointHandlerMapping,
							false)
							: getEndpointPaths(ManagementWebSecurityConfigurerAdapter.this.endpointHandlerMapping);
