...
public class WebEndpointsRunner extends Suite {
	...
	// }
	//
	// private static List<Runner> createRunners(Class<?> clazz) throws
	// InitializationError {
	...
	// ReactiveWebServerApplicationContext context = new
	...
	//
	// private final Function<List<Class<?>>, ConfigurableApplicationContext>
	...
	// if (this.applicationContext instanceof
	// AnnotationConfigServletWebServerApplicationContext) {
