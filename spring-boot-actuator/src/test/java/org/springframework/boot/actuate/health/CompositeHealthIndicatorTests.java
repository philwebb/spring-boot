...
public class CompositeHealthIndicatorTests {
	...
	public void setup() {
		...
		given(this.one.health()).willReturn(Health.unknown("1", "1"));
		given(this.two.health()).willReturn(Health.unknown("2", "2"));
		given(this.three.health()).willReturn(Health.unknown("3", "3"));
	...
	public void createWithIndicators() throws Exception {
		...
		assertThat(result.getDetails(),
				hasEntry("one", (Object) Health.unknown("1", "1")));
		assertThat(result.getDetails(),
				hasEntry("two", (Object) Health.unknown("2", "2")));
	}
	...
	public void createWithIndicatorsAndAdd() throws Exception {
		...
		assertThat(result.getDetails(),
				hasEntry("two", (Object) Health.unknown("2", "2")));
		assertThat(result.getDetails(),
				hasEntry("three", (Object) Health.unknown("3", "3")));
	}
