...
public class OAuth2ClientPropertiesRegistrationAdapterTests {
	...
	public void getClientRegistrationsWhenUsingDefinedProviderShouldAdapt()
		...
		registration.setClientAlias("clientAlias");
		...
		assertThat(adaptedProvider.getUserInfoUri()).isEqualTo("http://example.com/info");
		...
		assertThat(adapted.getClientAlias()).isEqualTo("clientAlias");
	}
	...
	public void getClientRegistrationsWhenUsingCommonProviderShouldAdapt()
		...
		assertThat(adaptedProvider.getUserInfoUri())
		...
		assertThat(adapted.getClientAlias()).isEqualTo("google");
	}
