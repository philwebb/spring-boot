...
public class JmsAutoConfigurationTests {
	...
	public void testDefaultJmsConfiguration() {
		this.contextLoader.withUserConfiguration(TestConfiguration.class).run(context -> {
	...
	public void testConnectionFactoryBackOff() {
		this.contextLoader.withUserConfiguration(TestConfiguration2.class)
	...
	public void testJmsTemplateBackOff() {
		this.contextLoader.withUserConfiguration(TestConfiguration3.class).run(context -> {
			JmsTemplate jmsTemplate = context.getBean(JmsTemplate.class);
	...
	public void testJmsMessagingTemplateBackOff() {
		this.contextLoader.withUserConfiguration(TestConfiguration5.class).run(context -> {
			JmsMessagingTemplate messagingTemplate = context
					.getBean(JmsMessagingTemplate.class);
	...
	public void testJmsTemplateBackOffEverything() {
		this.contextLoader.withUserConfiguration(TestConfiguration2.class, TestConfiguration3.class,
	...
	public void testEnableJmsCreateDefaultContainerFactory() {
		this.contextLoader.withUserConfiguration(EnableJmsConfiguration.class).run(context -> {
	...
	public void testJmsListenerContainerFactoryBackOff() {
		this.contextLoader
				.withUserConfiguration(TestConfiguration6.class, EnableJmsConfiguration.class)
				.run(context -> {
	...
	public void testJmsListenerContainerFactoryWithCustomSettings() {
		this.contextLoader.withUserConfiguration(EnableJmsConfiguration.class)
	...
	public void testDefaultContainerFactoryWithJtaTransactionManager() {
		this.contextLoader
				.withUserConfiguration(TestConfiguration7.class, EnableJmsConfiguration.class)
				.run(context -> {
					JmsListenerContainerFactory<?> jmsListenerContainerFactory = context
							.getBean("jmsListenerContainerFactory",
									JmsListenerContainerFactory.class);
	...
	public void testDefaultContainerFactoryNonJtaTransactionManager() {
		this.contextLoader
				.withUserConfiguration(TestConfiguration8.class, EnableJmsConfiguration.class)
				.run(context -> {
					JmsListenerContainerFactory<?> jmsListenerContainerFactory = context
							.getBean("jmsListenerContainerFactory",
									JmsListenerContainerFactory.class);
	...
	public void testDefaultContainerFactoryWithMessageConverters() {
		this.contextLoader.withUserConfiguration(MessageConvertersConfiguration.class,
	...
	public void testCustomContainerFactoryWithConfigurer() {
		this.contextLoader
				.withUserConfiguration(TestConfiguration9.class, EnableJmsConfiguration.class)
	...
	public void testJmsTemplateWithDestinationResolver() {
		this.contextLoader.withUserConfiguration(DestinationResolversConfiguration.class)
				.run(context -> {
					JmsTemplate jmsTemplate = context.getBean(JmsTemplate.class);
	...
	public void testJmsTemplatePostProcessedSoThatPubSubIsTrue() {
		this.contextLoader.withUserConfiguration(TestConfiguration4.class).run(context -> {
			JmsTemplate jmsTemplate = context.getBean(JmsTemplate.class);
	...
	public void testPubSubDomainActive() {
		this.contextLoader.withUserConfiguration(TestConfiguration.class)
	...
	public void enableJmsAutomatically() throws Exception {
		this.contextLoader.withUserConfiguration(NoEnableJmsConfiguration.class).run(context -> {
			context.getBean(
