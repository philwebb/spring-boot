...
public final class StaticResourceRequest {
	 ...
	 * {@link ResourceRequestMatcher#excluding(Location, Location...) excluding} method
	 ...
	 */
	public static ResourceRequestMatcher toCommonLocations() {
	 ...
	 * @return the configured {@link RequestMatcher}
	 */
	public static ResourceRequestMatcher to(Location first, Location... rest) {
	 ...
	 * @return the configured {@link RequestMatcher}
	 */
	public static ResourceRequestMatcher to(Set<Location> locations) {
		Assert.notNull(locations, "Locations must not be null");
		return new ResourceRequestMatcher(new LinkedHashSet<>(locations));
	}
	 ...
	 */
	public final static class ResourceRequestMatcher
		...
		private ResourceRequestMatcher(Set<Location> locations) {
			super(ServerProperties.class);
			this.locations = locations;
		}

		/**
		 * Return a new {@link ResourceRequestMatcher} based on this one but excluding the
		 * specified locations.
		 * @param first the first location to exclude
		 * @param rest additional locations to exclude
		 * @return a new {@link ResourceRequestMatcher}
		 */
		public ResourceRequestMatcher excluding(Location first, Location... rest) {
		 ...
		 * @return a new {@link ResourceRequestMatcher}
		 */
		public ResourceRequestMatcher excluding(Set<Location> locations) {
			Assert.notNull(locations, "Locations must not be null");
			Set<Location> subset = new LinkedHashSet<>(this.locations);
			subset.removeAll(locations);
			return new ResourceRequestMatcher(subset);
		}
