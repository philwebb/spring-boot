...
abstract class DataSourceConfiguration {
	...
	static class Tomcat extends DataSourceConfiguration {
		...
		@Bean
		@ConfigurationProperties(prefix = "spring.datasource.tomcat", validate = false)
	...
	static class Hikari extends DataSourceConfiguration {
		...
		@Bean
		@ConfigurationProperties(prefix = "spring.datasource.hikari", validate = false)
	...
	static class Dbcp extends DataSourceConfiguration {
		...
		@Bean
		@ConfigurationProperties(prefix = "spring.datasource.dbcp", validate = false)
	...
	static class Dbcp2 extends DataSourceConfiguration {
		...
		@Bean
		@ConfigurationProperties(prefix = "spring.datasource.dbcp2", validate = false)
