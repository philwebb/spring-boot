...
class CloudFoundryReactiveHealthEndpointWebExtensionTests {
	...
	private final ReactiveWebApplicationContextRunner contextRunner = new ReactiveWebApplicationContextRunner()
		...
		.withConfiguration(AutoConfigurations.of(ReactiveSecurityAutoConfiguration.class,
				...
				HealthEndpointAutoConfiguration.class, CloudFoundryReactiveActuatorAutoConfiguration.class))
	...
	void healthComponentsAlwaysPresent() {
		this.contextRunner.run((context) -> {
			...
			ContributedHealth body = extension.health(ApiVersion.V3).block(Duration.ofSeconds(30)).getBody();
