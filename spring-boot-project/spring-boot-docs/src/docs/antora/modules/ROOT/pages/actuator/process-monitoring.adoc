...
* xref:actuator/process-monitoring.adoc#process-monitoring.configuration[By Extending Configuration]
* xref:actuator/process-monitoring.adoc#process-monitoring.programmatically[Programmatically Enabling Process Monitoring]
...
[[process-monitoring.programmatically]]
