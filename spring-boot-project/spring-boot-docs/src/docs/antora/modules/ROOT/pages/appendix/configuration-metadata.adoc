...
However, it is possible to xref:appendix/configuration-metadata/annotation-processor.adoc#annotation-processor.adding-additional-metadata[write part of the metadata manually] for corner cases or more advanced use cases.
