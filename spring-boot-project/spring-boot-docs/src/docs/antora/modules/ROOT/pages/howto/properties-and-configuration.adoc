...
[[properties-and-configuration.expand-properties]]
...
[[properties-and-configuration.expand-properties.maven]]
...
[[properties-and-configuration.expand-properties.gradle]]
...
[[properties-and-configuration.external-properties-location]]
== Change the Location of External Properties of an Application
By default, properties from different sources are added to the Spring `Environment` in a defined order (see "`xref:features/external-config.adoc[Externalized Configuration]`" in the '`Spring Boot features`' section for the exact order).
...
TIP: If you want detailed information about the files that are being loaded you can xref:features/logging/log-levels.adoc[set the logging level] of `org.springframework.boot.context.config` to `trace`.



[[properties-and-configuration.short-command-line-arguments]]
...
[[properties-and-configuration.yaml]]
...
See "`xref:features/external-config/yaml.adoc[Working With YAML]`" in the '`Spring Boot features`' section for more information about YAML.



[[properties-and-configuration.set-active-spring-profiles]]
...
See "`xref:features/profiles.adoc[Profiles]`" in the "`Spring Boot features`" section for more information.



[[properties-and-configuration.set-default-spring-profile-name]]
...
[[properties-and-configuration.change-configuration-depending-on-the-environment]]
== Change Configuration Depending on the Environment
Spring Boot supports multi-document YAML and Properties files (see xref:features/external-config/files/multi-document.adoc[Working With Multi-Document Files] for details) which can be activated conditionally based on the active profiles.
...
[[properties-and-configuration.discover-build-in-options-for-external-properties]]
...
The appendix includes an xref:appendix/application-properties.adoc[`application.properties`] example with a list of the most common properties supported by Spring Boot.
...
For more about the exact ordering of loading properties, see "xref:features/external-config.adoc[Externalized Configuration]".
