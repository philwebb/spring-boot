...
See {code-spring-boot-autoconfigure}/ssl/JksSslBundleProperties.java[JksSslBundleProperties] for the full set of supported properties.
...
See {code-spring-boot-autoconfigure}/ssl/PemSslBundleProperties.java[PemSslBundleProperties] for the full set of supported properties.
...
See the sections on xref:how-to:webserver.adoc#howto.webserver.configure-ssl[embedded web servers], xref:documentation/data.adoc[data technologies], and xref:io/rest-client.adoc[REST clients] for further information.
