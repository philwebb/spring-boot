...
[[advanced.converting-executable-jars]]
== Converting a Spring Boot Executable Jar

It is possible to convert a Spring Boot xref:appendix/executable-jar.adoc[executable jar] into a native image as long as the jar contains the AOT generated assets.
...
[[advanced.converting-executable-jars.buildpacks]]
=== Using Buildpacks
...
[[advanced.converting-executable-jars.native-image]]
...
[[advanced.using-the-tracing-agent]]
...
[[advanced.using-the-tracing-agent.launch]]
