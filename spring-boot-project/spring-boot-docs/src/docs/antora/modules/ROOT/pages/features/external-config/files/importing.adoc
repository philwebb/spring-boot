...
NOTE: When appropriate, xref:features/external-config/files/profile-specific.adoc[Profile-specific variants] are also considered for import.
...
By default you can import Java Properties, YAML and "`xref:features/external-config/files/configtree.adoc[configuration trees]`".
