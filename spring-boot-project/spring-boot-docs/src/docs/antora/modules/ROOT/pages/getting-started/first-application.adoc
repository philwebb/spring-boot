...
Doing so generates a new project structure so that you can xref:ROOT:getting-started/first-application.adoc#getting-started.first-application.code[start coding right away].
