[[autoconfigured-spring-restdocs]]
...
[[autoconfigured-spring-restdocs.with-mock-mvc]]
...
[[autoconfigured-spring-restdocs.with-web-test-client]]
...
[[autoconfigured-spring-restdocs.with-rest-assured]]
