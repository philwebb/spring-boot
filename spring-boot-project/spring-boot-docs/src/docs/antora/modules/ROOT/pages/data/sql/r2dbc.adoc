...
TIP: The "`How-to`" section includes a xref:howto/data-initialization.adoc#data-initialization.using-basic-sql-scripts[section on how to initialize a database].
...
Similarly to xref:data/sql/datasource.adoc#datasource.embedded[the JDBC support], Spring Boot can automatically configure an embedded database for reactive usage.
