...
See {code-spring-boot-autoconfigure}/web/WebProperties.java[`WebProperties.Resources`] for more supported options.
...
TIP: See the {code-spring-boot-autoconfigure}/web/ServerProperties.java[`ServerProperties`] class for a complete list.
