...
* xref:howto/webserver.adoc#howto.webserver.configure-ssl[SSL]
* xref:howto/webserver.adoc#howto.webserver.enable-response-compression[HTTP compression]
...
For instance, xref:howto/webserver.adoc#howto.webserver.configure-access-logs[access logs] can be configured with specific features of the embedded servlet container.
