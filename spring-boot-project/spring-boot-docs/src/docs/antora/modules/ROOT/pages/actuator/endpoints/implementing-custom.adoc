...
[[implementing-custom.input.conversion]]
...
[[implementing-custom.web.method-predicates]]
=== HTTP method
...
[[implementing-custom.web.consumes-predicates]]
=== Consumes
...
[[implementing-custom.web.produces-predicates]]
=== Produces
...
[[implementing-custom.web.response-status]]
...
[[implementing-custom.web.range-requests]]
...
[[implementing-custom.web.security]]
...
[[implementing-custom.controller]]
