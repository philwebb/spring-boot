...
[[jpa-and-spring-data.entity-classes]]
== Entity Classes
...
[[jpa-and-spring-data.envers-repositories]]
...
[[jpa-and-spring-data.creating-and-dropping]]
...
[[jpa-and-spring-data.open-entity-manager-in-view]]
