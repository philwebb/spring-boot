[[autoconfigured-webservices]]
= Auto-configured Spring Web Services Tests



[[autoconfigured-webservices.client]]
...
TIP: A list of the auto-configuration settings that are enabled by `@WebServiceClientTest` can be xref:appendix/test-auto-configuration.adoc[found in the appendix].
...
[[autoconfigured-webservices.server]]
...
TIP: A list of the auto-configuration settings that are enabled by `@WebServiceServerTest` can be xref:appendix/test-auto-configuration.adoc[found in the appendix].
