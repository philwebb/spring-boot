...
Applications can opt in and record exceptions by xref:web/servlet/spring-mvc.adoc#spring-mvc.error-handling[setting handled exceptions as request attributes].
...
Applications can opt in and record exceptions by xref:web/reactive/webflux.adoc#webflux.error-handling[setting handled exceptions as request attributes].
...
[[supported.spring-data-repository]]
...
[[supported.mongodb.connection-pool]]
