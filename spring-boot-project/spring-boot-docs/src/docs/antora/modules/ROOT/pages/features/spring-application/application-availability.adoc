...
[[application-availability.liveness]]
== Liveness State
...
[[application-availability.readiness]]
== Readiness State
...
[[application-availability.managing]]
...
You can get more guidance about xref:deployment/cloud.adoc#cloud.kubernetes[deploying Spring Boot applications on Kubernetes in the dedicated section].
