...
If you do not add any specific cache library, Spring Boot auto-configures a xref:io/caching/provider.adoc#provider.simple[simple provider] that uses concurrent maps in memory.
