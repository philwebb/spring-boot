...
----
include::{include-java}/howto/jersey/springsecurity/JerseySetStatusOverSendErrorConfig.java[]
----



[[jersey.alongside-another-web-framework]]
...
[source,java,indent=0,subs="verbatim"]
----
include::{include-java}/howto/jersey/alongsideanotherwebframework/JerseyConfig.java[]
----
