...
[[application.troubleshoot-auto-configuration]]
...
[[application.customize-the-environment-or-application-context]]
...
See "`xref:features/spring-application/application-events-and-listeners.adoc[Application Events and Listeners]`" in the '`Spring Boot features`' section for a complete list.
...
See "`xref:features/spring-application/fluent-builder-api.adoc[Fluent Builder API]`" in the '`Spring Boot features`' section for more information.
