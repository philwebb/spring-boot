...
[[running-your-application.from-an-ide]]
== Running From an IDE
...
[[running-your-application.as-a-packaged-application]]
...
[[running-your-application.with-the-maven-plugin]]
...
[[running-your-application.with-the-gradle-plugin]]
...
[[running-your-application.hot-swapping]]
== Hot Swapping
...
See the xref:howto/hotswapping.adoc[Hot swapping "`How-to`"] for details.
