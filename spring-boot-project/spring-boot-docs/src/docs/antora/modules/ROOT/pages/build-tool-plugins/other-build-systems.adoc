...
Executable jars need to follow a specific format and certain entries need to be written in an uncompressed form (see the "`xref:appendix/executable-jar.adoc[executable jar format]`" section in the appendix for details).
...
[[other-build-systems.repackaging-archives]]
...
[[other-build-systems.nested-libraries]]
== Nested Libraries
...
[[other-build-systems.finding-main-class]]
...
[[other-build-systems.example-repackage-implementation]]
