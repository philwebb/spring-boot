...
See the {code-spring-boot-autoconfigure}/integration/IntegrationAutoConfiguration.java[`IntegrationAutoConfiguration`] and {code-spring-boot-autoconfigure}/integration/IntegrationProperties.java[`IntegrationProperties`] classes for more details.
