...
| Yes
| Limited (see xref:features/external-config/typesafe-configuration-properties/vs-value-annotation.adoc#features.external-config.typesafe-configuration-properties.vs-value-annotation.note[note below])
