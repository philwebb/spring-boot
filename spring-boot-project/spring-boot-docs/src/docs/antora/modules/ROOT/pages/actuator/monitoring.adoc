...
[[monitoring.customizing-management-server-context-path]]
...
[[monitoring.customizing-management-server-port]]
...
[[monitoring.management-specific-ssl]]
...
[[monitoring.customizing-management-server-address]]
...
[[monitoring.disabling-http-endpoints]]
