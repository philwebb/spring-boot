...
Spring Data repositories usually extend from the {url-spring-data-commons-javadoc}/repository/Repository.html[`Repository`] or {url-spring-data-commons-javadoc}/repository/CrudRepository.html[`CrudRepository`] interfaces.
