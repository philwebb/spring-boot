...
See xref:features/external-config/typesafe-configuration-properties/relaxed-binding.adoc#features.external-config.typesafe-configuration-properties.relaxed-binding.environment-variables[Binding From Environment Variables] for details.
