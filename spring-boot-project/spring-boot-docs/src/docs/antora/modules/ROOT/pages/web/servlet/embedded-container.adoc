...
* Creating a custom `error.jsp` page does not override the default view for xref:web/servlet/spring-mvc.adoc#web.servlet.spring-mvc.error-handling[error handling].
  xref:web/servlet/spring-mvc.adoc#web.servlet.spring-mvc.error-handling.error-pages[Custom error pages] should be used instead.
