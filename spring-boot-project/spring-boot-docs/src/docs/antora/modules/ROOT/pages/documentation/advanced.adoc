...
* *Appendix:* xref:application-properties.adoc[Application Properties] | xref:specification:configuration-metadata/index.adoc[Configuration Metadata] | xref:auto-configuration-classes.adoc[Auto-configuration Classes] | xref:test-auto-configuration.adoc[Test Auto-configuration Annotations] | xref:specification:executable-jar/index.adoc[Executable Jars] | xref:dependency-versions.adoc[Dependency Versions]
