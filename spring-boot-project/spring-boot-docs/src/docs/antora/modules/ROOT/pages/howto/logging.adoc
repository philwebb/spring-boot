...
You can also use `logback-spring.xml` if you want to use the xref:features/logging.adoc#features.logging.logback-extensions[Spring Boot Logback extensions].
