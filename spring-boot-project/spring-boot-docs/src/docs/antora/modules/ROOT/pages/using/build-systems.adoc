...
include::partial$using/starters/application-starters.adoc[]
...
include::partial$using/starters/production-starters.adoc[]

Finally, Spring Boot also includes the following starters that can be used if you want to exclude or swap specific technical facets:

.Spring Boot technical starters
include::partial$using/starters/technical-starters.adoc[]
