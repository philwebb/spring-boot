...
To learn how to swap technical facets, please see the how-to documentation for xref:howto/webserver/use-another.adoc[swapping web server] and xref:howto/logging.adoc#howto.logging.log4j[logging system].
