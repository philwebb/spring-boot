...
TIP: To learn more about the Actuator's endpoints and their request and response formats, see the xref:api:rest/actuator[API documentation].
...
See the xref:api:rest/actuator[API documentation] for details.
