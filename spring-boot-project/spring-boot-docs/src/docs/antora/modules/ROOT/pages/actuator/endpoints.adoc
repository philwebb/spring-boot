...
- No custom `xref:howto/actuator.adoc#howto.actuator.customizing-sanitization[SanitizingFunction]` beans apply
...
NOTE: This example assumes that no `xref:howto/actuator.adoc#howto.actuator.customizing-sanitization[SanitizingFunction]` beans have been defined.
