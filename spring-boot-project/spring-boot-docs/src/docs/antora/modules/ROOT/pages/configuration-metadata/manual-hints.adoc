...
| `logger-name`
| Auto-completes valid logger names and xref:features/logging.adoc#features.logging.log-groups[logger groups].
...
=== Logger Name
The **logger-name** provider auto-completes valid logger names and xref:features/logging.adoc#features.logging.log-groups[logger groups].
