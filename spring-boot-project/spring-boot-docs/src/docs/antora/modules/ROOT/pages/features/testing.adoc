...
The `@LocalServerPort` annotation can be used to xref:howto/webserver.adoc#howto.webserver.discover-port[inject the actual port used] into your test.
...
TIP: A list of the auto-configurations that are enabled by `@WebFluxTest` can be xref:test-auto-configuration.adoc[found in the appendix].
...
TIP: A list of the auto-configurations that are enabled by `@GraphQlTest` can be xref:test-auto-configuration.adoc[found in the appendix].
...
TIP: A list of the auto-configuration settings that are enabled by `@DataJpaTest` can be xref:test-auto-configuration.adoc[found in the appendix].
...
TIP: A list of the auto-configurations that are enabled by `@DataR2dbcTest` can be xref:test-auto-configuration.adoc[found in the appendix].
