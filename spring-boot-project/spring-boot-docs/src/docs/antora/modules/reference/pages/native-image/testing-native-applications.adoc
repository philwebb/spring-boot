...
You can also use Spring Boot xref:features/testing/spring-boot-applications/autoconfigured-tests.adoc[test slices] to test only specific parts of your application.
...
[[testing.with-native-build-tools.maven]]
=== Using Maven
...
[[testing.with-native-build-tools.gradle]]
=== Using Gradle
