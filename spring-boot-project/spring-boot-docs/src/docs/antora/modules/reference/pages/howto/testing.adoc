...
----
include::{include-java}/howto/testing/slicetests/MyConfiguration.java[]
----
...
[source,java,indent=0,subs="verbatim"]
----
include::{include-java}/howto/testing/slicetests/MySecurityConfiguration.java[]
----

[source,java,indent=0,subs="verbatim"]
----
include::{include-java}/howto/testing/slicetests/MyDatasourceConfiguration.java[]
----
