...
[[annotation-processor.configuring]]
...
[[annotation-processor.automatic-metadata-generation]]
...
For cases where the default value could not be detected, xref:appendix/configuration-metadata/annotation-processor.adoc#annotation-processor.adding-additional-metadata[manual metadata] should be provided.
Consider the following example:

include-code::./MyMessagingProperties[]

In order to document default values for properties in the class above, you could add the following content to xref:appendix/configuration-metadata/annotation-processor.adoc#annotation-processor.adding-additional-metadata[the manual metadata of the module]:
...
[[annotation-processor.automatic-metadata-generation.nested-properties]]
=== Nested Properties
...
[[annotation-processor.adding-additional-metadata]]
