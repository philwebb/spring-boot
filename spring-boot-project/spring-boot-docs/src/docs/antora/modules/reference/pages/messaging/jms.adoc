...
If you are running your application in an application server, Spring Boot tries to locate a JMS `org.springframework.jms.connection.ConnectionFactory` by using JNDI.
