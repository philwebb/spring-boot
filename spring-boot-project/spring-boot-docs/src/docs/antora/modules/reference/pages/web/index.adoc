...
If you have not yet developed a Spring Boot web application, you can follow the "Hello World!" example in the _xref:getting-started/first-application.adoc[Getting started]_ section.
