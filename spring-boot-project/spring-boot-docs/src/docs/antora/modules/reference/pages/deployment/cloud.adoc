...
In this section, we look at what it takes to get the xref:ROOT:getting-started/first-application.adoc[application that we developed] in the "`Getting Started`" section up and running in the Cloud.
