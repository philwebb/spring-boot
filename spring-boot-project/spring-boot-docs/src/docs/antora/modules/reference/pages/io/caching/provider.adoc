...
. xref:io/caching/provider.adoc#provider.generic[Generic]
. xref:io/caching/provider.adoc#provider.jcache[JCache (JSR-107)] (EhCache 3, Hazelcast, Infinispan, and others)
. xref:io/caching/provider.adoc#provider.hazelcast[Hazelcast]
. xref:io/caching/provider.adoc#provider.infinispan[Infinispan]
. xref:io/caching/provider.adoc#provider.couchbase[Couchbase]
. xref:io/caching/provider.adoc#provider.redis[Redis]
. xref:io/caching/provider.adoc#provider.caffeine[Caffeine]
. xref:io/caching/provider.adoc#provider.cache2k[Cache2k]
. xref:io/caching/provider.adoc#provider.simple[Simple]
...
Use this property if you need to xref:io/caching/provider.adoc#provider.none[disable caching altogether] in certain environments (such as tests).
...
If you have multiple JCache compliant cache providers and want to force the use of Hazelcast, you have to xref:io/caching/provider.adoc#provider.jcache[explicitly set the JCache provider].
