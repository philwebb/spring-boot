...
It is possible to convert a Spring Boot xref:ROOT:executable-jar.adoc[executable jar] into a native image as long as the jar contains the AOT generated assets.
