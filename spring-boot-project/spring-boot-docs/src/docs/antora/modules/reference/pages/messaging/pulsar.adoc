...
The properties supported by auto-configuration are shown in the xref:ROOT:application-properties#appendix.application-properties.integration["`Integration Properties`"] section of the Appendix.
