...
[[data-initialization.using-hibernate]]
...
This is done for you automatically if you enable the xref:features/logging/console-output.adoc[debug mode].
...
[[data-initialization.using-basic-sql-scripts]]
...
If you are using a xref:howto/data-initialization.adoc#data-initialization.migration-tool[Higher-level Database Migration Tool], like Flyway or Liquibase, you should use them alone to create and initialize the schema.
...
[[data-initialization.migration-tool]]
...
[[data-initialization.migration-tool.flyway]]
...
[[data-initialization.migration-tool.liquibase]]
...
[[data-initialization.dependencies.initializer-detection]]
...
[[data-initialization.dependencies.depends-on-initialization-detection]]
