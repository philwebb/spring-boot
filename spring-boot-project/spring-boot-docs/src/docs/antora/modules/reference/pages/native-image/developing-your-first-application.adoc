...
For our purposes, the simple "`Hello World!`" web application that's covered in the "`xref:ROOT:getting-started/first-application.adoc[Developing Your First Spring Boot Application]`" section will suffice.
