...
Several configuration properties are provided for xref:howto/spring-mvc.adoc#spring-mvc.customize-jackson-objectmapper[customizing the configuration of the `ObjectMapper`].



[[json.jackson.custom-serializers-and-deserializers]]
