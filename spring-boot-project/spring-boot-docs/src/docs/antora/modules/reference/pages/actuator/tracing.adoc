...
[[micrometer-tracing.getting-started]]
== Getting Started
...
[[micrometer-tracing.tracer-implementations]]
...
[[micrometer-tracing.tracer-implementations.otel-zipkin]]
...
[[micrometer-tracing.tracer-implementations.otel-wavefront]]
...
[[micrometer-tracing.tracer-implementations.brave-zipkin]]
...
[[micrometer-tracing.tracer-implementations.brave-wavefront]]
=== OpenZipkin Brave With Wavefront

* `io.micrometer:micrometer-tracing-bridge-brave` - which is needed to bridge the Micrometer Observation API to Brave.
* `io.micrometer:micrometer-tracing-reporter-wavefront` - which is needed to report traces to Wavefront.

[[micrometer-tracing.micrometer-observation]]
...
[[micrometer-tracing.creating-spans]]
