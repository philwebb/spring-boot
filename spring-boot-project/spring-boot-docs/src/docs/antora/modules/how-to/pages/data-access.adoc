...
If you need to externalize some settings, you can bind your `DataSource` to the environment (see "`xref:ROOT:features/external-config.adoc#features.external-config.typesafe-configuration-properties.third-party-configuration[Third-party Configuration]`").
...
See "`xref:ROOT:data/sql.adoc#data.sql.datasource[Configure a DataSource]`" in the "`Spring Boot features`" section and the {code-spring-boot-autoconfigure}/jdbc/DataSourceAutoConfiguration.java[`DataSourceAutoConfiguration`] class for more details.
...
Spring Boot determines the location of your `@Repository` definitions by scanning the xref:ROOT:using/auto-configuration.adoc#using.auto-configuration.packages[auto-configuration packages].
...
Spring Boot determines the location of your `@Entity` definitions by scanning the xref:ROOT:using/auto-configuration.adoc#using.auto-configuration.packages[auto-configuration packages].
...
See {code-spring-boot-autoconfigure}/orm/jpa/HibernateJpaAutoConfiguration.java[`HibernateJpaAutoConfiguration`] and {code-spring-boot-autoconfigure}/orm/jpa/JpaBaseConfiguration.java[`JpaBaseConfiguration`] for more details.
...
See {code-spring-boot-autoconfigure}/orm/jpa/JpaBaseConfiguration.java[`JpaBaseConfiguration`] for the default settings.
...
See {code-spring-boot-autoconfigure}/jooq/JooqAutoConfiguration.java[JooqAutoConfiguration] for more details.
