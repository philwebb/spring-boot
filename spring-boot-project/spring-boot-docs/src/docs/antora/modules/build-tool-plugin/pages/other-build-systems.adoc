...
Executable jars need to follow a specific format and certain entries need to be written in an uncompressed form (see the "`xref:ROOT:executable-jar.adoc[executable jar format]`" section in the appendix for details).
