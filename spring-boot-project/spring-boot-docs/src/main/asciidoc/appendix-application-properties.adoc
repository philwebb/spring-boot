...
----
	...
	management.endpoint.autoconfig.cache.time-to-live=0 # Maximum time in milliseconds that a response can be cached.
	management.endpoint.autoconfig.enabled= # Enable the autoconfig endpoint.
	...
	management.endpoints.web.mapping=
