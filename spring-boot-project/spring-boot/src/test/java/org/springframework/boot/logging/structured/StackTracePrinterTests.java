...
class StackTracePrinterTests {
	...
	private Throwable extracted() {
		Throwable cause = new RuntimeException("Bad luck");
		RuntimeException exception = new RuntimeException("Error", cause);
