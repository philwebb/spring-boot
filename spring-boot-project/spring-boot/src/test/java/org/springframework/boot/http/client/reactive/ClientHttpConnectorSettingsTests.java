...
/**
 * Tests for {@link ClientHttpConnectorSettings}.
 *
 * @author Phillip Webb
 */
class ClientHttpConnectorSettingsTests {
	...
	// ClientHttpRequestFactorySettings settings = new
	// ClientHttpRequestFactorySettings((HttpRedirects) null, null,
	// null, null);
	// assertThat(settings.redirects()).isEqualTo(Redirects.FOLLOW_WHEN_POSSIBLE);
	// assertThat(settings.httpRedirects()).isEqualTo(HttpRedirects.FOLLOW_WHEN_POSSIBLE);
	// assertThat(settings.connectTimeout()).isNull();
