...
/**
 * Tests for {@link MapPropertySourceChangeTracker}.
 *
 * @author Phillip Webb
 */
class MapPropertySourceChangeTrackerTests {

	private MapPropertySourceChangeTracker tracker = new MapPropertySourceChangeTracker();

	@Test
	void getStateWhenNotMapPropertySourceReturnsNull() {
		EnumerablePropertySource<?> propertySource = mock(EnumerablePropertySource.class);
		assertThat(this.tracker.getState(propertySource)).isNull();
	}
