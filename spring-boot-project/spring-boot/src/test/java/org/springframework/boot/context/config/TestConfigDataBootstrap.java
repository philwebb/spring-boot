...
import org.springframework.boot.env.BootstrapRegistry.ApplicationContextPreparedListener;
...
class TestConfigDataBootstrap {
	...
	static class LoaderHelper implements ApplicationContextPreparedListener {
		...
		@Override
		public void run(BootstrapRegistry bootstrapRegistry, ConfigurableApplicationContext applicationContext) {
