...
class EnvironmentPostProcessorApplicationListenerTests {
	...
	private DefaultBootstrapRegistry bootstrapRegistry = spy(new DefaultBootstrapRegistry());
	...
	void createUsesSpringFactories() {
		...
		assertThat(listener.getEnvironmentPostProcessors(this.bootstrapRegistry)).hasSizeGreaterThan(1);
	}
	...
	void createWhenHasFactoryUsesFactory() {
		...
		List<EnvironmentPostProcessor> postProcessors = listener.getEnvironmentPostProcessors(this.bootstrapRegistry);
	...
	void onApplicationEventWhenApplicationEnvironmentPreparedEventCallsPostProcessors() {
		...
		ApplicationEnvironmentPreparedEvent event = new ApplicationEnvironmentPreparedEvent(this.bootstrapRegistry,
