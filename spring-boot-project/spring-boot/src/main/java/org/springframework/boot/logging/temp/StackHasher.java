...
public class StackHasher {
	...
	/**
	 * Constructs a {@link StackHasher} using {@link StackElementFilter#withSourceInfo()}
	 * filter
	 */
	public StackHasher() {
	 ...
	 * <p>
	 * The first queue element is the stack hash for the topmost error, the next one (if
	 * any) is it's direct {@link Throwable#getCause() cause} hash, and so on...
	 * @param error the error to generate a hash from
