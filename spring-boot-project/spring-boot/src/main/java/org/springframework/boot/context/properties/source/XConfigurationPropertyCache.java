 ...
 * @since 2.3.0
 */
public final class XConfigurationPropertyCache {

	private static final XConfigurationPropertyCacheDelegate delegate = new XConfigurationPropertyCacheDelegate(
			Clock.systemUTC());

	private XConfigurationPropertyCache() {
	}
