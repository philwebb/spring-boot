...
/**
 * Options controlling the contents of {@link ErrorAttributes}.
 *
 * @author Scott Frederick
 * @since 2.3.0
 */
public class ErrorAttributeOptions2 {
	...
	ErrorAttributeOptions2(boolean includeException, boolean includeStackTrace, boolean includeMessage,
	 ...
	 */
	public ErrorAttributeOptions2 includeException(boolean include) {
		return new ErrorAttributeOptions2(include, this.includeStackTrace, this.includeMessage,
	 ...
	 * @return an updated {@code ErrorAttributeOptions}
	 */
	public ErrorAttributeOptions2 includeStackTrace(boolean include) {
		return new ErrorAttributeOptions2(this.includeException, include, this.includeMessage,
				this.includeBindingErrors);
	}
	 ...
	 * @return an updated {@code ErrorAttributeOptions}
	 */
	public ErrorAttributeOptions2 includeMessage(boolean include) {
		return new ErrorAttributeOptions2(this.includeException, this.includeStackTrace, include,
				this.includeBindingErrors);
	}
	 ...
	 * @return an updated {@code ErrorAttributeOptions}
	 */
	public ErrorAttributeOptions2 includeBindingErrors(boolean include) {
		return new ErrorAttributeOptions2(this.includeException, this.includeStackTrace, this.includeMessage, include);
	}
