 ...
 * @since 2.0.0
 */
public final class DataSourceBuilder3<T extends DataSource> {
	...
	private DataSourceBuilder3(ClassLoader classLoader) {
	...
	public <D extends DataSource> DataSourceBuilder3<D> type(Class<D> type) {
		return (DataSourceBuilder3<D>) this;
	}
	 ...
	 * @return this builder
	 */
	public DataSourceBuilder3<T> url(String url) {
	 ...
	 * @return this builder
	 */
	public DataSourceBuilder3<T> driverClassName(String driverClassName) {
	 ...
	 * @return this builder
	 */
	public DataSourceBuilder3<T> username(String username) {
	 ...
	 * @return this builder
	 */
	public DataSourceBuilder3<T> password(String password) {
	...
	/**
	 * Create a new {@link DataSourceBuilder3} instance.
	 * @return a new datasource builder instance
	 */
	public static DataSourceBuilder3<?> create() {
		return create(null);
	}
	 ...
	 * @return a new datasource builder instance
	 */
	public static DataSourceBuilder3<?> create(ClassLoader classLoader) {
		return new DataSourceBuilder3<>(classLoader);
	}
