...
public class SpringApplicationBuilder {
	 ...
	 * the {@link BootstrapRegistry}.
	 * @param bootstrapRegistryInitializers the bootstraper
	 * @return the current builder
	 * @since 2.4.5
	 */
	public SpringApplicationBuilder addBootstrappers(BootstrapRegistryInitializer... bootstrapRegistryInitializers) {
		this.application.addBootstrappers(bootstrapRegistryInitializers);
		return this;
	}
