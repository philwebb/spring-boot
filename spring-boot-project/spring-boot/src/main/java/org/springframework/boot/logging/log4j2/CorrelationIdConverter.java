 ...
 * pattern into formatted output using data from the {@link LogEvent#getContextData() MDC}
 * and the {@link Environment}.
 *
 * @author Phillip Webb
 * @since 3.1.0
...
public final class CorrelationIdConverter extends LogEventPatternConverter {
	...
	public static CorrelationIdConverter newInstance(String[] options) {
		return new CorrelationIdConverter(CorrelationIdFormatter.of(options));
	}
