...
/**
 * Component in charge of accepting or rejecting {@link StackTraceElement elements} when
 * computing a stack trace hash
 */
public abstract class StackElementFilter {

	/**
	 * Tests whether or not the specified {@link StackTraceElement} should be accepted
	 * when computing a stack hash.
	...
	/**
	 * Creates a {@link StackElementFilter} that accepts all stack trace elements with a
	 * non {@code null} {@code {@link StackTraceElement#getFileName()} filename} and
	 * positive {@link StackTraceElement#getLineNumber()} line number}
	 * @return the filter
	 */
	 ...
	 * @param excludes regular expressions matching {@link StackTraceElement} to filter
	 * out
	 * @return the filter
	 */
