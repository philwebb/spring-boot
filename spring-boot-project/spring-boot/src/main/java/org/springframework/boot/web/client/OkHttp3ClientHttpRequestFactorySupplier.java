...
/**
 * {@link ClientHttpRequestFactorySupplier} for {@link OkHttp3ClientHttpRequestFactory}.
 *
 * @author Andy Wilkinson
 */
class OkHttp3ClientHttpRequestFactorySupplier implements ClientHttpRequestFactorySupplier {

	@Override
	public ClientHttpRequestFactory get(Settings settings) {
		Assert.isNull(settings.bufferRequestBody(),
