...
class MariaDbR2dbcContainerConnectionDetailsFactory
		extends ContainerConnectionDetailsFactory<R2dbcConnection, R2dbcConnectionDetails, MariaDBContainer<?>> {

	@Override
	public R2dbcConnectionDetails getContainerConnectionDetails(
			ContainerConnectionSource<R2dbcConnection, R2dbcConnectionDetails, MariaDBContainer<?>> source) {
