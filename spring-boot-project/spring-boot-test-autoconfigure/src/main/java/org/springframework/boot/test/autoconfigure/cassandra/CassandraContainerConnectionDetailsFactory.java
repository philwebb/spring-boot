 ...
 * {@link CassandraConnection @CassandraConnection} annotated {@link CassandraContainer}
 * fields.
 *
...
class CassandraContainerConnectionDetailsFactory extends
		ContainerConnectionDetailsFactory<CassandraConnection, CassandraConnectionDetails, CassandraContainer<?>> {

	@Override
	protected CassandraConnectionDetails getContainerConnectionDetails(
			ContainerConnectionSource<CassandraConnection, CassandraConnectionDetails, CassandraContainer<?>> source) {
