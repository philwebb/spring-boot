 ...
 * {@link CouchbaseConnection @CouchbaseConnection} annotated {@link CouchbaseContainer}
 * fields.
 *
...
class CouchbaseContainerConnectionDetailsFactory
		extends ContainerConnectionDetailsFactory<CouchbaseConnection, CouchbaseConnectionDetails, CouchbaseContainer> {

	@Override
	protected CouchbaseConnectionDetails getContainerConnectionDetails(
			ContainerConnectionSource<CouchbaseConnection, CouchbaseConnectionDetails, CouchbaseContainer> source) {
