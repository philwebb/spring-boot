...
/**
 * {@link ContainerConnectionDetailsFactory} for {@link Neo4jConnection @Neo4jConnection}
 * annotated {@link Neo4jContainer} fields.
 *
...
class Neo4jContainerConnectionDetailsFactory
		extends ContainerConnectionDetailsFactory<Neo4jConnection, Neo4jConnectionDetails, Neo4jContainer<?>> {

	@Override
	protected Neo4jConnectionDetails getContainerConnectionDetails(
			ContainerConnectionSource<Neo4jConnection, Neo4jConnectionDetails, Neo4jContainer<?>> source) {
