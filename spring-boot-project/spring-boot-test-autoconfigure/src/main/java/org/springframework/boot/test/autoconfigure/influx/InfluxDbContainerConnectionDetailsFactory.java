 ...
 * {@link InfluxDbConnection @InfluxDbConnection} annotated {@link InfluxDBContainer}
 * fields.
 *
...
class InfluxDbContainerConnectionDetailsFactory
		extends ContainerConnectionDetailsFactory<InfluxDbConnection, InfluxDbConnectionDetails, InfluxDBContainer<?>> {

	@Override
	protected InfluxDbConnectionDetails getContainerConnectionDetails(
			ContainerConnectionSource<InfluxDbConnection, InfluxDbConnectionDetails, InfluxDBContainer<?>> source) {
