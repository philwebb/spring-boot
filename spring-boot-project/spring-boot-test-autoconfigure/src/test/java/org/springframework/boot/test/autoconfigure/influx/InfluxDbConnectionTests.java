...
import org.springframework.boot.test.autoconfigure.influx.InfluxDbConnectionTests.TestConfiguration;
...
/**
 * Tests for {@link InfluxDbConnection}.
 *
 * @author Andy Wilkinson
 */
@SpringBootTest(classes = TestConfiguration.class)
@Testcontainers(disabledWithoutDocker = true)
class InfluxDbConnectionTests {
