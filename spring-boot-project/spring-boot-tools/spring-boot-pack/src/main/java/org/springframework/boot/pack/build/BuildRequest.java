...
public class BuildRequest {
	...
	private static final ImageReference DEFAULT_BUILDER = ImageReference.of("cloudfoundry/cnb:bionic");
	...
	public BuildRequest withCleanCache(boolean cleanCache) {
		return new BuildRequest(this.name, this.applicationContent, DEFAULT_BUILDER, this.env, cleanCache,
				this.versboseLogging);
	}
	...
	public BuildRequest withVerboseLogging(boolean verboseLogging) {
		return new BuildRequest(this.name, this.applicationContent, DEFAULT_BUILDER, this.env, this.cleanCache,
				verboseLogging);
	}
