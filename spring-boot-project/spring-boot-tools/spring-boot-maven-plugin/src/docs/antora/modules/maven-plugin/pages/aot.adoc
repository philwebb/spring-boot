...
NOTE: For an overview of GraalVM Native Images support in Spring Boot, check the xref:ROOT:native-image.adoc[reference documentation].
...
A single project can trigger the generation of a native image on the command-line using either xref:ROOT:native-image/developing-your-first-application.adoc#native-image.developing-your-first-application.buildpacks.maven[Cloud Native Buildpacks] or xref:ROOT:native-image/developing-your-first-application.adoc#native-image.developing-your-first-application.native-build-tools.maven[Native Image Build Tools].
