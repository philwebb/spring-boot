...
class ReactiveManagementContextFactoryTests {
	...
	void createManagementContextShouldCreateChildContextWithConfigClasses() {
		...
		this.parent.refresh();
		AnnotationConfigReactiveWebServerApplicationContext childContext = this.factory
				.createManagementContext(this.parent, true);
		childContext.register(TestConfiguration1.class, TestConfiguration2.class);
