...
include::partial$actuator/rest/metrics/names/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/metrics/names/http-response.adoc[]
...
[cols="3,1,2"]
include::partial$actuator/rest/metrics/names/response-fields.adoc[]
...
include::partial$actuator/rest/metrics/metric/curl-request.adoc[]

The preceding example retrieves information about the metric named `jvm.memory.max`.
The resulting response is similar to the following:

include::partial$actuator/rest/metrics/metric/http-response.adoc[]



[[metrics.retrieving-metric.query-parameters]]
=== Query Parameters
The endpoint uses query parameters to xref:actuator/rest/metrics.adoc#metrics.drilling-down[drill down] into a metric by using its tags.
The following table shows the single supported query parameter:

[cols="2,4"]
include::partial$actuator/rest/metrics/metric-with-tags/query-parameters.adoc[]
...
include::partial$actuator/rest/metrics/metric/response-fields.adoc[]
...
include::partial$actuator/rest/metrics/metric-with-tags/curl-request.adoc[]
...
include::partial$actuator/rest/metrics/metric-with-tags/http-response.adoc[]
