...
include::partial$actuator/rest/mappings/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/mappings/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/mappings/response-fields.adoc[]
...
[cols="4,1,2"]
include::partial$actuator/rest/mappings/response-fields-dispatcher-servlets.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/mappings/response-fields-servlets.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/mappings/response-fields-servlet-filters.adoc[]
...
[cols="4,1,2"]
include::partial$actuator/rest/mappings/response-fields-dispatcher-handlers.adoc[]
