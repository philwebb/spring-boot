...
include::partial$actuator/scheduled-tasks/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/scheduled-tasks/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/scheduled-tasks/response-fields.adoc[]
