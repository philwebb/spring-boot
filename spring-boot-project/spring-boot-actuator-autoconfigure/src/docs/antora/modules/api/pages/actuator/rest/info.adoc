...
include::partial$actuator/rest/info/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/info/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/info/response-fields-beneath-build.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/info/response-fields-beneath-git.adoc[]
