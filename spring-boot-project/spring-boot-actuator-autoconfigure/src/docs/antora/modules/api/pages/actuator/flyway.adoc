...
include::partial$actuator/flyway/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/flyway/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/flyway/response-fields.adoc[]
