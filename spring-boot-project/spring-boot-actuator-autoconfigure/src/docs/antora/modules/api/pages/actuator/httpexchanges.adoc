...
include::partial$actuator/httpexchanges/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/httpexchanges/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/httpexchanges/response-fields.adoc[]
