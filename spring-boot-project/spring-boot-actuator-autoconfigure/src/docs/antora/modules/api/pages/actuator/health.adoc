...
include::partial$actuator/health/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/health/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/health/response-fields.adoc[]
...
include::partial$actuator/health/component/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/health/component/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/health/component/response-fields.adoc[]
...
include::partial$actuator/health/instance/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/health/instance/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/health/instance/response-fields.adoc[]
