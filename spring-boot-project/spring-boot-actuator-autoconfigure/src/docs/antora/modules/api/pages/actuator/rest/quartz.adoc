...
include::partial$actuator/rest/quartz/report/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/quartz/report/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/rest/quartz/report/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/jobs/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/quartz/jobs/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/rest/quartz/jobs/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/triggers/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/quartz/triggers/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/rest/quartz/triggers/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/job-group/curl-request.adoc[]

The preceding example retrieves the summary for jobs in the `samples` group.
The resulting response is similar to the following:

include::partial$actuator/rest/quartz/job-group/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/rest/quartz/job-group/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/trigger-group/curl-request.adoc[]

The preceding example retrieves the summary for triggers in the `tests` group.
The resulting response is similar to the following:

include::partial$actuator/rest/quartz/trigger-group/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/rest/quartz/trigger-group/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/job-details/curl-request.adoc[]

The preceding example retrieves the details of the job identified by the `samples` group and `jobOne` name.
The resulting response is similar to the following:

include::partial$actuator/rest/quartz/job-details/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/quartz/job-details/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/trigger-details-cron/curl-request.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/quartz/trigger-details-common/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/trigger-details-cron/http-response.adoc[]


Much of the response is common to all trigger types.
The structure of the common elements of the response was xref:actuator/rest/quartz.adoc#quartz.trigger.common-response-structure[described previously].
The following table describes the structure of the parts of the response that are specific to cron triggers:

[cols="2,1,3"]
include::partial$actuator/rest/quartz/trigger-details-cron/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/trigger-details-simple/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/quartz/trigger-details-simple/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/trigger-details-daily-time-interval/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/quartz/trigger-details-daily-time-interval/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/trigger-details-calendar-interval/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/quartz/trigger-details-calendar-interval/response-fields.adoc[]
...
include::partial$actuator/rest/quartz/trigger-details-custom/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/quartz/trigger-details-custom/response-fields.adoc[]
