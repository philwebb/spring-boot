...
include::partial$actuator/rest/integrationgraph/graph/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/integrationgraph/graph/http-response.adoc[]
...
include::partial$actuator/rest/integrationgraph/rebuild/curl-request.adoc[]

This will result in a `204 - No Content` response:

include::partial$actuator/rest/integrationgraph/rebuild/http-response.adoc[]
