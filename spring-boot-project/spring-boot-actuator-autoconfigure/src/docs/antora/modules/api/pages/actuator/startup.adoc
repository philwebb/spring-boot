...
include::partial$actuator/startup-snapshot/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/startup-snapshot/http-response.adoc[]
...
include::partial$actuator/startup/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/startup/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/startup/response-fields.adoc[]
