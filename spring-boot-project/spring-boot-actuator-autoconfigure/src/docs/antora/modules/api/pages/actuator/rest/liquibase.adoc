...
include::partial$actuator/rest/liquibase/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/liquibase/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/liquibase/response-fields.adoc[]
