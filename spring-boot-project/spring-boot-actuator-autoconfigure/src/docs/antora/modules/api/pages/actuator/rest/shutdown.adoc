...
include::partial$actuator/rest/shutdown/curl-request.adoc[]

A response similar to the following is produced:

include::partial$actuator/rest/shutdown/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/rest/shutdown/response-fields.adoc[]
