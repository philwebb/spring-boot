...
include::partial$actuator/rest/flyway/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/flyway/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/flyway/response-fields.adoc[]
