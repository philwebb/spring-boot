...
include::partial$actuator/quartz/report/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/quartz/report/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/quartz/report/response-fields.adoc[]
...
include::partial$actuator/quartz/jobs/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/quartz/jobs/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/quartz/jobs/response-fields.adoc[]
...
include::partial$actuator/quartz/triggers/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/quartz/triggers/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/quartz/triggers/response-fields.adoc[]
...
include::partial$actuator/quartz/job-group/curl-request.adoc[]

The preceding example retrieves the summary for jobs in the `samples` group.
The resulting response is similar to the following:

include::partial$actuator/quartz/job-group/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/quartz/job-group/response-fields.adoc[]
...
include::partial$actuator/quartz/trigger-group/curl-request.adoc[]

The preceding example retrieves the summary for triggers in the `tests` group.
The resulting response is similar to the following:

include::partial$actuator/quartz/trigger-group/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/quartz/trigger-group/response-fields.adoc[]
...
include::partial$actuator/quartz/job-details/curl-request.adoc[]

The preceding example retrieves the details of the job identified by the `samples` group and `jobOne` name.
The resulting response is similar to the following:

include::partial$actuator/quartz/job-details/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/quartz/job-details/response-fields.adoc[]
...
include::partial$actuator/quartz/trigger-details-cron/curl-request.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/quartz/trigger-details-common/response-fields.adoc[]
...
include::partial$actuator/quartz/trigger-details-cron/http-response.adoc[]


Much of the response is common to all trigger types.
The structure of the common elements of the response was xref:actuator/quartz.adoc#quartz.trigger.common-response-structure[described previously].
The following table describes the structure of the parts of the response that are specific to cron triggers:

[cols="2,1,3"]
include::partial$actuator/quartz/trigger-details-cron/response-fields.adoc[]
...
include::partial$actuator/quartz/trigger-details-simple/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/quartz/trigger-details-simple/response-fields.adoc[]
...
include::partial$actuator/quartz/trigger-details-daily-time-interval/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/quartz/trigger-details-daily-time-interval/response-fields.adoc[]
...
include::partial$actuator/quartz/trigger-details-calendar-interval/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/quartz/trigger-details-calendar-interval/response-fields.adoc[]
...
include::partial$actuator/quartz/trigger-details-custom/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/quartz/trigger-details-custom/response-fields.adoc[]
