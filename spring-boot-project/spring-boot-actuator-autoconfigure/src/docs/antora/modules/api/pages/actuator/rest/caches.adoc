...
include::partial$actuator/rest/caches/all/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/caches/all/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/rest/caches/all/response-fields.adoc[]
...
include::partial$actuator/rest/caches/named/curl-request.adoc[]

The preceding example retrieves information about the cache named `cities`.
The resulting response is similar to the following:

include::partial$actuator/rest/caches/named/http-response.adoc[]
...
[cols="2,4"]
include::partial$actuator/rest/caches/named/query-parameters.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/rest/caches/named/response-fields.adoc[]
...
include::partial$actuator/rest/caches/evict-all/curl-request.adoc[]
...
include::partial$actuator/rest/caches/evict-named/curl-request.adoc[]
...
[cols="2,4"]
include::partial$actuator/rest/caches/evict-named/query-parameters.adoc[]
