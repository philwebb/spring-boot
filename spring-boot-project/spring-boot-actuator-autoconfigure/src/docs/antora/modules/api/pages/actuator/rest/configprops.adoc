...
include::partial$actuator/rest/configprops/all/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/configprops/all/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/configprops/all/response-fields.adoc[]
...
include::partial$actuator/rest/configprops/prefixed/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/configprops/prefixed/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/configprops/prefixed/response-fields.adoc[]
