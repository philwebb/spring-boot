...
include::partial$actuator/rest/startup-snapshot/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/startup-snapshot/http-response.adoc[]
...
include::partial$actuator/rest/startup/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/startup/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/startup/response-fields.adoc[]
