...
include::partial$actuator/rest/prometheus/all/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/prometheus/all/http-response.adoc[]
...
include::partial$actuator/rest/prometheus/openmetrics/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/prometheus/openmetrics/http-response.adoc[]
...
[cols="2,4"]
include::partial$actuator/rest/prometheus/names/query-parameters.adoc[]
...
include::partial$actuator/rest/prometheus/names/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/prometheus/names/http-response.adoc[]
