...
include::partial$actuator/rest/beans/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/beans/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/rest/beans/response-fields.adoc[]
