...
include::partial$actuator/rest/conditions/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/rest/conditions/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/rest/conditions/response-fields.adoc[]
