...
include::partial$actuator/integrationgraph/graph/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/integrationgraph/graph/http-response.adoc[]
...
include::partial$actuator/integrationgraph/rebuild/curl-request.adoc[]

This will result in a `204 - No Content` response:

include::partial$actuator/integrationgraph/rebuild/http-response.adoc[]
