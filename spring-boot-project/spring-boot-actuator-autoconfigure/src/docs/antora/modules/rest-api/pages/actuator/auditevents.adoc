...
include::partial$actuator/auditevents/filtered/curl-request.adoc[]
...
include::partial$actuator/auditevents/filtered/http-response.adoc[]
...
[cols="2,4"]
include::partial$actuator/auditevents/filtered/query-parameters.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/auditevents/all/response-fields.adoc[]
