...
include::partial$actuator/liquibase/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/liquibase/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/liquibase/response-fields.adoc[]
