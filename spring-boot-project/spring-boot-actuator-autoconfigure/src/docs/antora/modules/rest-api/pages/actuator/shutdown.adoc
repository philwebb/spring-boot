...
include::partial$actuator/shutdown/curl-request.adoc[]

A response similar to the following is produced:

include::partial$actuator/shutdown/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/shutdown/response-fields.adoc[]
