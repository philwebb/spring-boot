...
include::partial$actuator/conditions/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/conditions/http-response.adoc[]
...
[cols="3,1,3"]
include::partial$actuator/conditions/response-fields.adoc[]
