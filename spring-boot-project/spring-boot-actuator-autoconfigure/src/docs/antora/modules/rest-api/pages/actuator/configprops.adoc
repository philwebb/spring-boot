...
include::partial$actuator/configprops/all/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/configprops/all/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/configprops/all/response-fields.adoc[]
...
include::partial$actuator/configprops/prefixed/curl-request.adoc[]

The resulting response is similar to the following:

include::partial$actuator/configprops/prefixed/http-response.adoc[]
...
[cols="2,1,3"]
include::partial$actuator/configprops/prefixed/response-fields.adoc[]
