...
public class CloudFoundryHealthEndpointWebExtension {
	...
	public WebEndpointResponse<HealthComponent> health(ApiVersion apiVersion) {
		return this.delegate.health(apiVersion, SecurityContext.NONE, ServerContext.EMPTY, true);
	}

	@ReadOperation
	public WebEndpointResponse<HealthComponent> health(ApiVersion apiVersion,
			@Selector(match = Match.ALL_REMAINING) String... path) {
		return this.delegate.health(apiVersion, SecurityContext.NONE, ServerContext.EMPTY, true, path);
	}
