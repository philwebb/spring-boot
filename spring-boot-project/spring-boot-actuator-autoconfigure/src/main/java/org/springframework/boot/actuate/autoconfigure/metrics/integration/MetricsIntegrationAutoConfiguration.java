...
@ConditionalOnMissingBean(value = { IntegrationManagementConfigurer.class,
		MetricsFactory.class }, name = IntegrationManagementConfigurer.MANAGEMENT_CONFIGURER_NAME, search = SearchStrategy.CURRENT)
...
public class MetricsIntegrationAutoConfiguration {
	...
	protected static class MetricsIntegrationManagementConfiguration {
