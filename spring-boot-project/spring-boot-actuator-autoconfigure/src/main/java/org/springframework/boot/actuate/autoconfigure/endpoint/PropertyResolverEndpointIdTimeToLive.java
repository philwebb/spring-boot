 ...
 * @since 2.0.0
 */
public class PropertyResolverEndpointIdTimeToLive implements Function<String, Long> {
	 ...
	 */
	PropertyResolverEndpointIdTimeToLive(PropertyResolver propertyResolver) {
