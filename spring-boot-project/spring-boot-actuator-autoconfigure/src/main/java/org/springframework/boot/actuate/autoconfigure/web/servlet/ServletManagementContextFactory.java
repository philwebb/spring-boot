 ...
 */
class ServletManagementContextFactory
		implements ManagementContextFactory<AnnotationConfigServletWebServerApplicationContext> {

	@Override
	public AnnotationConfigServletWebServerApplicationContext createManagementContext(ApplicationContext parent,
		...
		if (registerWebServerFactoryBeans) {
			child.register(ServletWebServerFactoryAutoConfiguration.class);
