 ...
 * @since 3.1.0
 */
public record DockerComposeOrigin(Path configFile, String serviceName) implements Origin {

	@Override
	public String toString() {
		return "docker compose service '%s' defined in '%s'".formatted(this.serviceName, this.configFile);
	}
