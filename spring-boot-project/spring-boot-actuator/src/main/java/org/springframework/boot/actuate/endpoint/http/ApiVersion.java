...
/**
 * API versions supported for the actuator HTTP API. This enum may be injected into web
 * endpoints in order to return a responsible compatible with the requested version.
 *
 * @author Phillip Webb
 * @since 2.2.0
 */
