...
public class ReactiveHealthEndpointWebExtension
	...
	public Mono<WebEndpointResponse<? extends HealthComponent>> health(SecurityContext securityContext,
		...
		HealthResult<Mono<? extends HealthComponent>> result = getHealthResult(securityContext, alwaysIncludeDetails,
				path);
		if (result == null) {
	...
	@Override
	protected Mono<? extends HealthComponent> aggregate(Map<String, Mono<? extends HealthComponent>> contributions,
