...
package org.springframework.boot.data.autoconfigure;
...
class RepositoryMetricsAutoConfigurationTests {
	...
	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
		...
		.withConfiguration(AutoConfigurations.of(MetricsAutoConfiguration.class,
				SpringDataRepositoryMetricsAutoConfiguration.class))
		.withPropertyValues("management.metrics.use-global-registry=false");

	@Test
	void backsOffWhenMeterRegistryIsMissing() {
		new ApplicationContextRunner()
			.withConfiguration(AutoConfigurations.of(SpringDataRepositoryMetricsAutoConfiguration.class))
