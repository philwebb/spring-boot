...
class FlywayAutoConfigurationTests {
	...
	void createDataSourceFallbackToEmbeddedProperties() {
		this.contextRunner.withUserConfiguration(EmbeddedDataSourceConfiguration.class)
				.withPropertyValues("spring.flyway.url:jdbc:hsqldb:mem:flywaytest").run((context) -> {
					...
					assertThat(dataSource).hasFieldOrPropertyWithValue("username", "sa");
	...
	static abstract class AbstractUserH2DataSourceConfiguration {

		@Bean(destroyMethod = "shutdown")
		public EmbeddedDatabase dataSource(DataSourceProperties properties) throws SQLException {
