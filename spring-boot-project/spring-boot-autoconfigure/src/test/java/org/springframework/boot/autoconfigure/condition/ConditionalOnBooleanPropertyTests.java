...
class ConditionalOnBooleanPropertyTests {
	...
	static class HavingValueTrueMatchIfMissingFalse {
	...
	static class HavingValueTrueMatchIfMissingTrue {
	...
	static class HavingValueFalseMatchIfMissingFalse {
	...
	static class HavingValueFalseMatchIfMissingTrue {
