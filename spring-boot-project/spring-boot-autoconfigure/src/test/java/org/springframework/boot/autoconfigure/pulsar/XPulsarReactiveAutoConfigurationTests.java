...
class XPulsarReactiveAutoConfigurationTests {
	...
	class SenderCacheAutoConfigurationTests {
		...
		void cachingEnabledByDefault() {
			XPulsarReactiveAutoConfigurationTests.this.contextRunner.run(this::assertCaffeineProducerCacheProvider);
		}

		@Test
		void cachingEnabledExplicitly() {
			XPulsarReactiveAutoConfigurationTests.this.contextRunner
