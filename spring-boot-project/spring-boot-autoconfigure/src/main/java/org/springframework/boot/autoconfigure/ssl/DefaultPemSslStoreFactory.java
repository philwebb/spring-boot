...
class DefaultPemSslStoreFactory implements PemSslStoreFactory {
	...
	private PemSslStore getPemSslStore(String bundleName, PemSslBundleProperties.Store properties,
	...
	private <F, S> F select(BundleContentProperty bundleContentProperty, ThrowingFunction<Path, F> fileFactory,
		...
		Assert.state(selected != null, () -> nonSelectedMessage.apply(candidates));
		return selected;
	}
