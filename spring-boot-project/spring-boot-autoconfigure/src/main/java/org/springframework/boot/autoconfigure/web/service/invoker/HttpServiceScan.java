...
/**
 * Configures scanning directives for use with {@link HttpService @HttpService} classes.
 *
 * @author Phillip Webb
 */
...
@Documented
@Repeatable(HttpServiceScan.Container.class)
public @interface HttpServiceScan {
	...
	/**
	 * Repeatable container for {@link HttpServiceScan @HttpServiceScan}
	 */
	@Retention(RetentionPolicy.RUNTIME)
	@Target(ElementType.TYPE)
	@Documented
