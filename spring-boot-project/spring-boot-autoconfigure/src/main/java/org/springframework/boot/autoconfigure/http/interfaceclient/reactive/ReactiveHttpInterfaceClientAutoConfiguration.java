...
/**
 * AutoConfiguration for Spring reactive HTTP Interface Clients.
 * <p>
 * This will result in the creation of reactive interface client beans defined by
...
public class ReactiveHttpInterfaceClientAutoConfiguration implements BeanClassLoaderAware {

	private ClassLoader beanClassLoader;

	ReactiveHttpInterfaceClientAutoConfiguration() {
	}
	...
	WebClientPropertiesHttpServiceGroupConfigurer webClientPropertiesHttpServiceGroupConfigurer(
		...
		return new WebClientPropertiesHttpServiceGroupConfigurer(this.beanClassLoader, sslBundles,
				httpReactiveClientProperties, clientConnectorBuilder, clientConnectorSettings);
	}
