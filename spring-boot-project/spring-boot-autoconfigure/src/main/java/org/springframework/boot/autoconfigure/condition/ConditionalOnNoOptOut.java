...
/**
 * {@link Conditional @Conditional} that checks that a user has not opted-out of a
 * specific feature by looking at the value of an {@code <prefix>.enabled} property. The
 * condition matches as long as the user has set the value to true or omitted it entirely.
 *
 * @author Phillip Webb
 * @since 3.5.0
...
public @interface ConditionalOnNoOptOut {
