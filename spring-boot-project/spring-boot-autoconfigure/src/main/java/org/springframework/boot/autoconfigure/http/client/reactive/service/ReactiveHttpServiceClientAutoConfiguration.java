...
public class ReactiveHttpServiceClientAutoConfiguration implements BeanClassLoaderAware {
	...
	WebClientPropertiesHttpServiceGroupConfigurer webClientPropertiesHttpServiceGroupConfigurer(
			ObjectProvider<SslBundles> sslBundles, HttpReactiveClientSettingsProperties settingsProperties,
		...
		return new WebClientPropertiesHttpServiceGroupConfigurer(this.beanClassLoader, sslBundles, settingsProperties,
				serviceProperties, clientConnectorBuilder, clientConnectorSettings);
	}
