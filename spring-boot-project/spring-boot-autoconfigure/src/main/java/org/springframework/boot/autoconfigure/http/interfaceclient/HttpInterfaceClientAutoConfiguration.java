 ...
 * <p>
 * This will result in the creation of blocking interface client beans defined by
...
public class HttpInterfaceClientAutoConfiguration implements BeanClassLoaderAware {

	private ClassLoader beanClassLoader;

	HttpInterfaceClientAutoConfiguration() {
	}
	...
	RestClientPropertiesHttpServiceGroupConfigurer restClientPropertiesHttpServiceGroupConfigurer(
		...
		return new RestClientPropertiesHttpServiceGroupConfigurer(this.beanClassLoader, sslBundles,
				httpClientProperties, clientFactoryBuilder, clientHttpRequestFactorySettings);
	}
