...
public class PropertiesMongoConnectionDetails implements MongoConnectionDetails {
	...
	public ConnectionString getConnectionString() {
		...
		if (this.properties.getReplicaSetName() != null || this.properties.getAuthenticationDatabase() != null) {
			builder.append("/");
	...
	public GridFs getGridFs() {
		return new GridFs() {
			...
			public String getDatabase() {
				return PropertiesMongoConnectionDetails.this.properties.getGridfs().getDatabase();
			}

			@Override
			public String getBucket() {
				return PropertiesMongoConnectionDetails.this.properties.getGridfs().getBucket();
			}
