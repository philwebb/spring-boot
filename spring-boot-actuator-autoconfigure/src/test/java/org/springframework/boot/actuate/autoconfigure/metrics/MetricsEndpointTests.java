...
public class MetricsEndpointTests {
	...
	public void listNames() throws IOException {
		List<String> names = this.mapper.readValue(
				this.loopback.getForObject("/application/metrics", String.class),
	...
	public void selectByName() throws IOException {
		Map<String, Collection<MetricsEndpoint.MeasurementSample>> measurements = this.mapper
				.readValue(
						this.loopback.getForObject("/application/metrics/jvm.memory.used",
								String.class),
