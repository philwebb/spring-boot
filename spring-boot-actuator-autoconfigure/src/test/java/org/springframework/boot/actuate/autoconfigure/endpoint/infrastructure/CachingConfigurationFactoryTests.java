 ...
 */
public class CachingConfigurationFactoryTests {

	private final MockEnvironment environment = new MockEnvironment();

	private final CachingConfigurationFactory factory = new CachingConfigurationFactory(
			this.environment);

	@Test
	public void defaultConfiguration() {
		CachingConfiguration configuration = this.factory.apply("test");
