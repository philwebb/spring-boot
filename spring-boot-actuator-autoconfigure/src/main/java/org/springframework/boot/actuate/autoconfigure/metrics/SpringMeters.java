...
/**
 * Helper methods for monitoring infrastructure commonly found in a Spring application.
 *
...
public final class SpringMeters {
	...
	public static DataSource monitor(MeterRegistry registry, DataSource dataSource,
			Collection<DataSourcePoolMetadataProvider> metadataProviders, String name,
			Tag... tags) {
		return monitor(registry, dataSource, metadataProviders, name,
				Arrays.asList(tags));
	}
	...
	public static ThreadPoolTaskScheduler monitor(MeterRegistry registry,
		...
		ExecutorServiceMetrics.monitor(registry, scheduler.getScheduledExecutor(), name,
				tags);
		return scheduler;
	}
