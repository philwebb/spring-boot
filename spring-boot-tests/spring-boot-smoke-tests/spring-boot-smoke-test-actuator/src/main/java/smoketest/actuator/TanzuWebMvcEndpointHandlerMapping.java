...
class TanzuWebMvcEndpointHandlerMapping extends AbstractWebMvcEndpointHandlerMapping {
	...
	class WebMvcLinksHandler implements LinksHandler {
		...
		public Map<String, Map<String, Link>> links(HttpServletRequest request, HttpServletResponse response) {
			return Collections.singletonMap("_links", TanzuWebMvcEndpointHandlerMapping.this.linksResolver
				.resolveLinks(request.getRequestURL().toString()));
		}

		@Override
		public String toString() {
			return "Tanzu Actuator root web endpoint";
		}
