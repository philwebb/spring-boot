...
public class SampleInterfaceClient2FunctionalApplication {
	...
	static class Registrar implements BeanRegistrar {
		...
		public void register(BeanRegistry registry, Environment env) {
			RestClientHttpServiceProxies proxies = RestClientHttpServiceProxies
				.ofScan("smoktest.interfaceclient.scenario2.generated")
				.restClient((builder) -> builder.baseUrl("https://echo.zuplo.io"));
