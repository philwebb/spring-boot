...
public class SpringCloudAutoConfiguration {
	...
	@Bean
	RestClientHttpServiceGroupConfigurer springCloudRestClientHttpServiceGroupConfigurer() {
		return (groups) -> groups.configureClient(this::configureClient);
	}

	public void configureClient(RestClient.Builder restClientBuilder) {
		restClientBuilder.requestInterceptor(this::intercept);
	}
