...
package smoktest.interfaceclient.scenario5.programmatic;

import java.io.IOException;
import java.nio.charset.StandardCharsets;
import java.util.Map;

import smoktest.interfaceclient.scenario5.programmatic.SampleInterfaceClient5ProgrammaticApplication.Registrar;
...
public class SampleInterfaceClient5ProgrammaticApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(SampleInterfaceClient5ProgrammaticApplication.class, args);
	}
