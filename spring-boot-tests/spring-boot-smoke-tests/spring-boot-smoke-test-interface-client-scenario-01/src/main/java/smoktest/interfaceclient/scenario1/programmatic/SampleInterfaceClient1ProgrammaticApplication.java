...
package smoktest.interfaceclient.scenario1.programmatic;

import java.util.Map;

import smoktest.interfaceclient.scenario1.programmatic.SampleInterfaceClient1ProgrammaticApplication.Registrar;
...
public class SampleInterfaceClient1ProgrammaticApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(SampleInterfaceClient1ProgrammaticApplication.class, args);
	}
