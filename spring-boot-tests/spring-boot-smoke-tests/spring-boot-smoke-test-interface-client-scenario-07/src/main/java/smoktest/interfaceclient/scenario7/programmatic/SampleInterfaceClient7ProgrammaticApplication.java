...
package smoktest.interfaceclient.scenario7.programmatic;

import java.util.List;
import java.util.Map;

import smoktest.interfaceclient.scenario7.programmatic.SampleInterfaceClient7ProgrammaticApplication.Registrar;
...
public class SampleInterfaceClient7ProgrammaticApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(SampleInterfaceClient7ProgrammaticApplication.class, args);
	}
