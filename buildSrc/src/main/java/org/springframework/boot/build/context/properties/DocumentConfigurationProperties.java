...
public class DocumentConfigurationProperties extends DefaultTask {
	...
	void documentConfigurationProperties() throws IOException {
		...
		snippets.add("application-properties.dev-services", "Dev Services Properties", this::devServicesPrefixes);
	...
	private void devServicesPrefixes(Config prefix) {
		prefix.accept("spring.dev-services");
	}
