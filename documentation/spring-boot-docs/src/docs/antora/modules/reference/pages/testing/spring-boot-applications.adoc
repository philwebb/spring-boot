...
If you can not or will not add webflux, the `spring-boot-restclient-test` modules provides a javadoc:org.springframework.boot.web.server.test.client.TestRestTemplate[] facility:
